...
public class Constant {
    ...
    public static final double DEFAULT_LINK_LENGTH = 30000*PROPAGATION_VELOCITY;
    public static final double HOST_TO_SWITCH_LENGTH = 30000*PROPAGATION_VELOCITY;
    
    // Host/Switch delay, default is 100ns
//    public static final int HOST_DELAY = 100000;
    
    public static final int HOST_DELAY = 100000;//ns => 10^5 * 10^(-9) = 10^(-4)(s)
//    public static final int HOST_DELAY = 50;//ns => 10^5 * 10^(-9) = 10^(-4)(s)
...
//    public static final int SWITCH_CYCLE = 10;
    ...
    public static final int SWITCH_LINK = 4;
    
    public static final int HOST_LINK = 1;
}
